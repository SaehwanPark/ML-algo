...
#     print(f"Error at lambda={test_lambda} =", run_linear_regression_on_MNIST(test_lambda))
...
#     print(f"softmax at T={temp_param} :", run_softmax_on_MNIST(temp_param))
...
# print('softmax test_error with 18 PCs=', test_error)
...
print('softmax test_error with cubic features =', test_error)